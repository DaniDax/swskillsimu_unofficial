(function (w) {
    ...
    */
    var localize = {
        ...
        Others: {
            CreativeCommon: "Creative Commons Attribution-NonCommercial-ShareAlike",
            CreativeCommonNote: "<span>Content is available under {0} unless stated.<br />Official Art, Game Content and Screenshots are trademarks and copyrights of {1} and the game's publishers.</span>",
        },
    };
